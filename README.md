...
> **Requires Node.js 20.19 or newer.** The lint and test toolchain (ESLint, `eslint-plugin-obsidianmd`, and the TypeScript-ESLint stack) depends on APIs introduced in Node 20.19. An `.nvmrc` is included — run `nvm use` to select the right version.
